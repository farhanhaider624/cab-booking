...
export default function ConfirmationCard({
  ...
  return (
    <div className="absolute bg-black/30 top-0 bottom-0 left-0 right-0 flex justify-center items-center">
      <form
        ref={form}
        className="w-[30%] bg-white rounded-lg drop-shadow-xl p-8"
      >
        {!cabBooked && (
          <>
        ...
        {cabBooked && (
          <div className="flex flex-col items-center justify-center">
            <p className="text-red-400 mt-4 text-center">
              Your cab has been booked successfully.<br></br> A confirmation
              mail has been sent to your email.
            </p>

            <button
              className="mt-6 bg-red-400 text-white rounded-lg py-2 px-5 w-16 hover:bg-red-500"
              onClick={onCancel}
            >
              OK
            </button>
